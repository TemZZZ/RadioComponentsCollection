...
namespace MVVM
{
    //TODO: данный класс является единственной реализацией интерфейса. А нужен ли интерфейс?
    //TODO: именование длинное, можно сократить до СomponentVM - для VM вполне ожидаемо выполнять функцию адаптера для модели
    /// <summary>
