...
namespace Model
{
    ...
    {
        //TODO: в классе хранится много данных, которые относятся к конкретным элементам - при добавлении нового компонента нужно реализовывать интерфейс И ЕЩЕ дополнительно править словари в этом классе,
        // + то есть очень плохая расширяемость. Есть какие-то практические причины, по которым нужно хранить все эти данные не в элементе, а здесь?
        /// <summary>
